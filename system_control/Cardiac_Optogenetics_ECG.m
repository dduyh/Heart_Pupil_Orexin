...
mouse_name = 'm2249';            % Mouse name\
date = 'Jun_02_2025';           % Date\
...
ch3 = addCounterOutputChannel(s,'Dev1','ctr1','PulseGeneration'); % PFI13
...
% setup stim schedule
% stimSchedule = [500/60 10 700/60 800/60 15 1000/60];
% stimSchedule = [15 800/60 700/60 10 500/60];
% stimSchedule = [15 15 15 800/60 800/60 800/60];
% stimSchedule = [5 5 5 400/60 400/60 400/60];
% stimSchedule = [400/60 400/60 400/60 5 5 5];
stimSchedule = [5 5 5 200/60 200/60 200/60];
ntrials = length(stimSchedule);

% settings for trial timeline
stimLength = 30;
interTrialInterval = 60;
...
ch3.DutyCycle = 10/(1000/ch3.Frequency);
