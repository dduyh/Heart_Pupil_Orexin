...
mouse_name = 'm59';            % Mouse name\
date = 'Jul_01_2024';           % Date\  
...
vid.ROIPosition = [240 296 812 447];

vid.LoggingMode = 'disk';
diskLogger = VideoWriter([Data_Folder 'heart.avi'], 'Grayscale AVI');
...
lh = addlistener(s,'DataAvailable', @(src, event)ECGRunningPlot(src, event, ax1, ax2, ax3));
...
function ECGRunningPlot(src, event, ax1, ax2, ax3)
