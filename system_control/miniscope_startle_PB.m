...
mouse_name = 'm2071';            % Mouse name\
date = 'Feb_19_2025';           % Date\
...
te = 2; % signal duration in seconds
...
ch4 = addDigitalChannel(s,'Dev1','port0/line0','InputOnly');
...
t.StartDelay = 900; % wait 900 secs
