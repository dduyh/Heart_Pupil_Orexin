...
ch5 = addDigitalChannel(s1,'Dev2','port0/line0','InputOnly');

% Configure a new listener to process the incoming data.
lh = addlistener(s1,'DataAvailable', @(src, event)RunningECGPulsePlot(src, event, ax1, ax2, ax3, ax4));
