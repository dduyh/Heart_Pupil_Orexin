...
title('Atenolol','FontSize',20,'FontWeight','bold')
...
line([0,0],[100,800],'Color','k','linestyle','--','LineWidth',2);
xlim([-pre_bout_duration (trace_duration-pre_bout_duration)])
ylim([100 500])
ax = gca;
ax.XAxis.Visible = 'off'; % remove x-axis
...
xlim([-pre_bout_duration (trace_duration-pre_bout_duration)])
line([0,0],[400,600],'Color','k','linestyle','--','LineWidth',2);
ylim([400 570])
ax = gca;
% ax.XAxis.Visible = 'off'; % remove x-axis
ax.LineWidth = 1.2;
