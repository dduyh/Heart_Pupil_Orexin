...
[maxcorr_runpup,l] = max(mean(r_runpup));
plot([xlims(l) xlims(l)],[-0.05 maxcorr_runpup],'--','Color',[229 114 190]./255,'LineWidth',2)
ylim([-0.05 0.15])
...
[maxcorr_runHR,l] = max(mean(r_runHR));
plot([xlims(l) xlims(l)],[-0.02 maxcorr_runHR],'--','Color',[229 114 190]./255,'LineWidth',2)
ylim([-0.02 0.04])
ylabel('Correlation coefficient','FontSize',15,'FontWeight','bold');
xlim([-5 5])
xticks(-5:1:5)
...
[maxcorr_HRpup,l] = max(mean(r_HRpup));
plot([xlims(l) xlims(l)],[-0.05 maxcorr_HRpup],'--','Color',[229 114 190]./255,'LineWidth',2)
ylim([-0.05 0.3])
ylabel('Correlation coefficient','FontSize',15,'FontWeight','bold');
xlim([-5 5])
xticks(-5:1:5)
