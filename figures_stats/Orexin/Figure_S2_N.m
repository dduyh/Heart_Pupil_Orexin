...
b1 = boxchart(state,heart_rate_data,'GroupByColor',state,'BoxFaceAlpha',1,'BoxWidth',2,'LineWidth',2,'BoxMedianLineColor','black','BoxEdgeColor','black','MarkerStyle','none');
...
text(1.5, 760, '**', 'FontSize', 20, 'FontWeight','bold', 'HorizontalAlignment', 'center');

ylim([300 800])
ylabel('HR (bpm)','FontSize',20,'FontWeight','bold');
title('DTR- (fed)','FontSize',18,'FontWeight','bold')
...
ylim([300 800])
ylabel('HR (bpm)','FontSize',20,'FontWeight','bold');
title('DTR- (fasted)','FontSize',18,'FontWeight','bold')
