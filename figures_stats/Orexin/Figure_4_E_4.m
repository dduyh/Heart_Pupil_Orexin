...
title('Atropinum','FontSize',20,'FontWeight','bold')
...
line([0,0],[-0.6,4.5],'Color','k','linestyle','--','LineWidth',2);
xlim([-pre_bout_duration (trace_duration-pre_bout_duration)])
ylim([-0.6 1.3])
ax = gca;
ax.XAxis.Visible = 'off'; % remove x-axis
...
line([0,0],[1600,2800],'Color','k','linestyle','--','LineWidth',2);
xlim([-pre_bout_duration (trace_duration-pre_bout_duration)])
ylim([1600 2800])
ax = gca;
ax.XAxis.Visible = 'off'; % remove x-axis
...
xlim([-pre_bout_duration (trace_duration-pre_bout_duration)])
line([0,0],[630,790],'Color','k','linestyle','--','LineWidth',2);
ylim([630,790])
ax = gca;
% ax.XAxis.Visible = 'off'; % remove x-axis
ax.LineWidth = 1.2;
