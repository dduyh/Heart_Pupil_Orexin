...
for I=1:size(sucrose_folder,1)
    ...
    mean_ch1 = mean([Sucrose_ch1_static Quinine_ch1_static]);
    std_ch1 = std([Sucrose_ch1_static Quinine_ch1_static]);
    
    Sucrose_ch1_zscored = (Sucrose_ch1_static - mean_ch1) / std_ch1;
    Sucrose_max_zscore_ch1 = [Sucrose_max_zscore_ch1; max(Sucrose_ch1_zscored)];
    
    Quinine_ch1_zscored = (Quinine_ch1_static - mean_ch1) / std_ch1;
    Quinine_max_zscore_ch1 = [Quinine_max_zscore_ch1; max(Quinine_ch1_zscored)];
    
    mean_ch2 = mean([Sucrose_ch2_static Quinine_ch2_static]);
    std_ch2 = std([Sucrose_ch2_static Quinine_ch2_static]);
    
    Sucrose_ch2_zscored = (Sucrose_ch2_static - mean_ch2) / std_ch2;
    Sucrose_max_zscore_ch2 = [Sucrose_max_zscore_ch2; max(Sucrose_ch2_zscored)];

    Quinine_ch2_zscored = (Quinine_ch2_static - mean_ch2) / std_ch2;
