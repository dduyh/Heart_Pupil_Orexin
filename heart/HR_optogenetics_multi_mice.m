...
HR_trials(II,:) = raw_trial_smooth;

    end

    figure(1);
    hold on
    plot(xlims,mean(HR_trials),'LineWidth',1)
...
patch('XData',[0, 0, 60, 60],'YData',[520, 620, 620, 520],'EdgeColor','none','FaceColor','green','FaceAlpha',0.2);

plot(xlims,mean(trials),'Color','k','LineWidth',2)
title('Heart Rate (Chrimson)','FontSize',20,'FontWeight','bold')
ylabel('HR','FontSize',15,'FontWeight','bold');
