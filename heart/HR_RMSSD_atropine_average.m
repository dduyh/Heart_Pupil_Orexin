...
title({'Heart Rate Before/After Atropine Injection','',''},'FontSize',24,'FontWeight','bold')
...
title({'HRV Before/After Atropine Injection','',''},'FontSize',24,'FontWeight','bold')
