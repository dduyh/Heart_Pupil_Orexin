...
heartRate_bpm_interp = interp1(pksLocs(2:end)*Sample_Rate,heartRate_bpm,0:time(end)*Sample_Rate,'spline','extrap');
heartRate_bpm_interp_smooth = movmean(heartRate_bpm_interp,1*Sample_Rate);
